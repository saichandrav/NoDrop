  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-linear-to-r from-neutral-900 to-blue-950  relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-4xl flex flex-col md:flex-row shadow-2xl rounded-3xl overflow-hidden border border-white/5 bg-white/5 backdrop-blur-xl m-4">
        ...
        <div className="w-full md:w-1/2 p-12 flex flex-col items-center justify-center bg-linear-to-br from-blue-900/40 to-black/40 border-b md:border-b-0 md:border-r border-white/5 relative">
          ...
          <form onSubmit={handleSubmit} className='flex flex-col gap-5'>
            ...
            <div className="group">
              ...
              <Link to="/forgot-password">
                <p className='text-blue-300/80 mb-2 ml-1 text-right'>forgot password ?</p>
              </Link>
            </div>
            ...
            <p className="text-center text-sm text-gray-500 mt-4">
              Don't have an account? <Link to="/signup" className="text-cyan-400 hover:text-cyan-300 transition-colors">Sign up</Link>
            </p>
          </form>
        </div>
      </div>
